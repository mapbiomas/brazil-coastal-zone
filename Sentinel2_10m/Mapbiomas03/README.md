...
# About
This repository provides the steps to map classes located in the **Brazilian Coastal Zone** using Sentinel-2 mosaics.
...
The deep learning workflow focuses on identifying HTF areas from Sentinel-2 mosaics. It involves generating annual cloud-free mosaics using Google Earth Engine (GEE) and applying a [U-Net](https://arxiv.org/abs/1505.04597) model for semantic segmentation.
...
Sentinel-2 Mosaics:
        ...
        Generate annual cloud-free mosaics from January 1st to December 31st for the period 2016–2024.
        Apply filter to reduce clouds and cloud shadows.
...
Samples        | 22459(Train), 4421 (Validation)|
...
* Script:  [Integration.js](./Integration.js)
