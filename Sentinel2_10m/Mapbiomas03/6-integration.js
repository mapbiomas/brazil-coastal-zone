...
for (var year = initialYear;year<=finalYear;year++){
    ...
    Export.image.toAsset({
        image:zc.toByte().set({'year':parseInt(year, 10),'territory':'BRAZIL','collection_id':3.0,'version':versionIntegration,'theme':'ZONACOSTEIRA'}),
        description:'zc-postfiltered-'+year+'-'+versionIntegration,
        assetId:'projects/'+userEEProject+'/assets/'+userPath+'/COLLECTION-3/COASTAL-ZONE/classification/'+year+'-'+versionIntegration,
        scale:scale,
        region:ROI,
